...
const percentages = [ 0, 0, 0, 0, 0, 0, 0, 10, 20, 25, 38, 50, 62, 75, 80, 90, 100, 100, 100, 100, 100, 100, 100]

const sections = [
    [ KEY.AURA, KEY.BAR_1, KEY.G1, KEY.G2, KEY.G3, KEY.G4, KEY.G5, KEY.G6, KEY.NZXT_1_1, KEY.NZXT_1_20, KEY.NZXT_2_20 ],
    ...
    [ KEY.NUM_ENTER, KEY.NUM_PLUS, KEY.NUM_MINUS, KEY.NEXT, KEY.BAR_19, KEY.NZXT_1_9, KEY.NZXT_1_12, KEY.NZXT_2_1, KEY.HUE_1 ],
];
